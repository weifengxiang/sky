...
<script type="text/javascript" src='${basepath}jsp/sys/organ/editsysorgantype.js'></script>
...
<div class="easyui-panel"  style="width:100%;height:100%;text-align: center;"
	 data-options="footer:'#editPageButtonsFt'">
		<form id="addeditsysorgantypeform" class="easyui-form" method="post" 
			...
			<table style="width:100%">
				  ...
				  <tr>
					...
					<td colspan='3'>
						<input class="easyui-textbox" name="note" style="width:400px;height: 100px"
...
<div id='editPageButtonsFt' style="text-align:center; padding:0px; top:0px">
	<a href="javascript:void(0)" class="easyui-linkbutton" iconCls='icon-save'
		onclick="submitAddEditSysOrganTypeForm()">保存</a> 
