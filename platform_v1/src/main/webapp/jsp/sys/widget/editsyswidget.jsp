...
<script type="text/javascript" src='${basepath}jsp/sys/widget/editsyswidget.js'></script>
...
<div class="easyui-panel"  style="width:100%;height:100%;text-align: center;"
	 data-options="footer:'#editPageButtonsFt'">
		<form id="addeditsyswidgetform" class="easyui-form" method="post" 
...
<div id='editPageButtonsFt' style="text-align:center; padding:0px; top:0px">
	<a href="javascript:void(0)" class="easyui-linkbutton" iconCls='icon-save'
		onclick="submitAddEditSysWidgetForm()">保存</a> 
